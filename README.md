...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6f2041be-634d-4f9f-9619-d717489ff743
```

> `6f2041be-634d-4f9f-9619-d717489ff743` is the password of the certificate, you can change it to any password you want.
